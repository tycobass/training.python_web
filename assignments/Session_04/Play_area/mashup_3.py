...
def load_inspection_page(name):
    ...
    #return file_path.read_text(encoding='utf8')  ### original command try to let system figure out the encoding
...
if __name__ == '__main__':
    ...
    for data_div in data_list:
        ...
        print(metadata)
        #with open('inspection_page_03.html', 'w') as fh:  # these two lines necessary to work around dos window encoding error
         #   fh.write(metadata.prettify())